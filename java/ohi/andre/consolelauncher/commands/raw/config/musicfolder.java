...
public class musicfolder implements CommandAbstraction {
	...
	public String exec(ExecInfo info) {
		...
		Storage.writeSongPath(edit, folder.getAbsolutePath());
		edit.commit();
		
		return info.res.getString(R.string.output_musicfolder);
	}
	...
	@Override
	public int helpRes() {
		return R.string.help_musicfolder;
	}
