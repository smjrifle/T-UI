...
public class bgcolor implements CommandAbstraction {

    public static final String SYSTEM_WALLPAPER_ACTIVATOR = "default";

	@Override
	public int helpRes() {
		return R.string.help_bgcolor;
	}
